		...
		glfwSetKeyCallback(m_Window, [](GLFWwindow* window, int key, int scanmode, int action, int mods)
			{
				...
				switch (action)
				{
					...
					case GLFW_REPEAT:
					{
						// glfw doesn't provide us with a repeat count
						// even though win32 api can do that, so we'll set the 0 to a 1
						// and remember that in the future, this is possible to extract
